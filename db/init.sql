...
CREATE TABLE operation_types (id serial NOT NULL, description text);
...
CREATE TABLE transactions (id serial NOT NULL, account_id INTEGER, operation_type_id INTEGER, amount FLOAT, event_date TIMESTAMP);
